...
export default function Nav({showMainModal, resetGame, solutionName}) {
  return (
    <header className="bg-white border-b-2 border-grey-300 mb-2">
        <nav className="mx-auto flex w-1/4 justify-between p-2 lg:px-4" aria-label="Global">
            ...
            <div className='flex'>
                <div onClick={showMainModal} className="pointer-events-auto rounded-full p-1 text-gray-400 hover:text-black focus:outline-none">
